...
namespace Hex
{
    public class FormsUI : ControlManager
    {
        #region Constructors

        public FormsUI(GraphicsDevice graphicsDevice, Action<Action<ContentManager>> subscribeToLoad, Action<Action<GameTime>> subscribeToUpdate, Action<Action<SpriteBatch>> subscribeToDraw)
            : base(graphicsDevice, subscribeToLoad, subscribeToUpdate, subscribeToDraw)
        {
        }

        #endregion

        #region ControlManager Implementation
        ...
        public override void InitializeComponent()
        {
            ...
            form1.BackgroundColor = Color.Transparent;
