...
namespace Mogi.Helpers
{
    ...
    public class DependencyHelper
    {
        ...
        /// <remarks> This overload is constrainted to <see cref="IRegister"/> because it is indended to be called inside <see cref="IRegister.Register(DependencyMap)"/>. </remarks>
        ...
        where TRoot : class, IRoot
    {
            ...
            where TDependency : class
        {
            ...
            if (instance is IRegister loader)
                loader.Register(this.DependencyMap);
